...
max_doctors_per_term <- rowSums(cbind(
  term_master_df$`PGY2 Term 1 Allocation`,
  term_master_df$`PGY2 Term 2 Allocation`,
  term_master_df$`PGY2 Term 3 Allocation`,
  term_master_df$`PGY2 Term 4 Allocation`,
  term_master_df$`PGY2 Term 5 Allocation`
), na.rm = TRUE)
...
top_5_gt_BASIC <- gt(top_5_preference_complete) %>%
  tab_header(
    title = "Terms Ranked by % of Top 5 Preference"
  ) %>%
  cols_label(
    Term_Name = "Term Name",
...
top_5_gt_INTER <- gt(top_5_preference_complete) %>%
  tab_header(
    title = "PGY2 Terms Ranked by Total Surplus/Deficit"
  ) %>%
  cols_label(
    Term_Name = "Term Name",
    Percentage = "% Top 5 Preferences",
...
gtsave(top_5_gt_INTER, "PGY2 Subscription1.pdf", path = "C:/Users/Scotty/Desktop/R Subscription Data 2024 allocations")
...
top_5_gt <- gt(top_5_preference_complete) %>%
  tab_header(
    title = "PGY2 Terms Ranked by % Over/Under Subscription"
  ) %>%
  cols_label(
    Term_Name = "Term Name",
    Percentage = "% Top 5 Preferences",
...
# Print the gt table
print(top_5_gt)
gtsave(top_5_gt, "PGY2 Subscription2.pdf", path = "C:/Users/Scotty/Desktop/R Subscription Data 2024 allocations")
