...
# 3. Specialty Status Constraint
  ...
  for (i in 1:num_doctors) {
    ...
    # Ensure that a doctor does not get assigned more than 2 terms from the same specialty across all iterations
    terms_already_assigned <- specialty_assignments_tracker[i, specialty]
    remaining_assignments_allowed <- max(0, 2 - terms_already_assigned)
